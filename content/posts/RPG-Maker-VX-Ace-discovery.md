...
{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/1.webp" caption="This is what a regular encrypted game directory looks like" >}}
...
{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/2.webp" caption="The deployment screen from RPG Maker MZ" >}}
...
{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/3.webp" caption="Voila! We got the assets!" >}}
...
{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/4.webp" caption="Well, that was easy..." >}}

{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/5.webp" caption="There it is, the project file!" >}}
...
{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/6.webp" caption="30 days, no registration needed to use the trial, no complaints!" >}}
...
{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/7.webp" caption="Where is the .rgss3a file?" >}}

In order for my decryptor to work, it needed a .rgss2a file, and it would not accept anything else...

{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/8.webp" caption="Why can't you just work?" >}}

Then I had a realization, how does a freshly created RPG Maker project look like?

{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/9.webp" caption="A fresh RPG Maker VX Ace project" >}}

This looks awfully like a deployed game, so let's see what is inside of the .rvproj file...

{{< figure src="/images/posts/RPG-Maker-VX-Ace-discovery/10.webp" caption="You have to be kidding me..." >}}
